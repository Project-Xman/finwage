 ...
 * ```
 */
export function getCacheConfig(collectionName: keyof typeof COLLECTION_CACHE_CONFIG) {
  return COLLECTION_CACHE_CONFIG[collectionName] || {
    duration: CACHE_DURATION.MEDIUM,
    tags: [],
 ...
 * ```
 */
export function createRecordTag(collectionTag: string, identifier: string): string {
