...
export class BlogSeeder extends DependentSeeder {
  ...
  protected async getSeedData(): Promise<BlogSeedData[]> {
    ...
    const [ewaCategoryId, financialWellnessCategoryId, benefitsCategoryId] =
      categoryIds;
    ...
    return [
      {
        ...
        seo_description:
          "Learn everything about Earned Wage Access (EWA) - how it works, benefits for employees and employers, and why it's revolutionizing workplace benefits. No loans, no interest.",
        seo_keywords:
          "earned wage access, EWA, instant pay, on-demand pay, financial wellness, employee benefits, payroll advance",
        og_image: null,
        canonical_url: null,
      },
      {
        ...
        views: 1850,
        seo_title:
          "10 Proven Ways to Improve Employee Financial Wellness | FinWage",
        seo_description:
          "Reduce financial stress and boost productivity with these 10 proven employee financial wellness strategies. Includes earned wage access, education programs, and more.",
        seo_keywords:
          "employee financial wellness, financial stress, workplace benefits, HR strategies, employee engagement, financial education",
        og_image: null,
        canonical_url: null,
      },
      {
        ...
        views: 1200,
        seo_title:
          "The True Cost of Employee Turnover & How to Reduce It | FinWage",
        seo_description:
          "Discover the hidden costs of employee turnover and proven strategies to reduce it by up to 27% using modern financial wellness benefits.",
        seo_keywords:
          "employee turnover, turnover costs, employee retention, HR costs, retention strategies, earned wage access benefits",
        og_image: null,
        canonical_url: null,
      },
    ];
