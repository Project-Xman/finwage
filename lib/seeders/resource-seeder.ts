...
export class ResourceSeeder extends DependentSeeder {
  ...
  private getArticlesData(categoryIds: string[]): ResourceArticleSeedData[] {
    const [financialWellnessId, employeeRetentionId, payrollTrendsId, caseStudiesId, industryNewsId] = categoryIds;
    ...
    return [
      ...
      // Recent Articles
      {
        ...
        excerpt: 'Understanding the connection between financial wellness and workplace performance.',
        category: financialWellnessId,
      ...
      },
      {
        ...
        excerpt: 'A comprehensive guide for employers evaluating EWA solutions.',
        category: employeeRetentionId,
      ...
      },
      {
        ...
        excerpt: 'Navigate the regulatory environment for earned wage access programs.',
      ...
      },
      {
        ...
        excerpt: 'How one company transformed their retention strategy with earned wage access.',
      ...
      },
      {
        ...
        excerpt: 'Research insights on how pay frequency affects employee financial behavior.',
        category: financialWellnessId,
      ...
      },
      {
        ...
        excerpt: 'Step-by-step guide to creating an effective financial wellness initiative.',
        category: employeeRetentionId,
    ...
    return [
      {
        ...
        description: 'Everything you need to know about implementing EWA in your organization, from planning to rollout.',
      ...
      },
      {
        ...
        description: 'Calculate the potential return on investment for your financial wellness program.',
        file_url: '#',
        type: 'template',
        featured: false,
        active: true,
      ...
      },
      {
        ...
        description: 'Assess your employees\' financial wellness needs with this comprehensive survey template.',
        file_url: '#',
        type: 'template',
        featured: false,
        active: true,
