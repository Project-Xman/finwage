...
import { getEmployeeBenefitsMarketing as apiFetchEmployeeBenefits } from "@/lib/api";
import type { EmployeeBenefitsResponse } from "@/types/pocketbase";
 ...
 * ```
 */
export async function getBenefitsGroupedByCategory(): Promise<
  Record<string, EmployeeBenefitsResponse[]>
> {
  try {
