...
export type AuthorsResponse<
  Tsocial_link = unknown,
  Texpand = unknown,
> = Required<AuthorsRecord<Tsocial_link>> & BaseSystemFields<Texpand>;
export type BlogsResponse<Ttags = unknown, Texpand = unknown> = Required<
  BlogsRecord<Ttags>
> &
  BaseSystemFields<Texpand>;
export type CategoryResponse<Texpand = unknown> = Required<CategoryRecord> &
  BaseSystemFields<Texpand>;
export type CompanyMilestonesResponse<Texpand = unknown> =
  Required<CompanyMilestonesRecord> & BaseSystemFields<Texpand>;
export type ComplianceItemsResponse<
  Tdetails = unknown,
  Texpand = unknown,
> = Required<ComplianceItemsRecord<Tdetails>> & BaseSystemFields<Texpand>;
export type ContactOptionsResponse<Texpand = unknown> =
  Required<ContactOptionsRecord> & BaseSystemFields<Texpand>;
export type CtaCardsResponse<Tpoints = unknown, Texpand = unknown> = Required<
  CtaCardsRecord<Tpoints>
> &
  BaseSystemFields<Texpand>;
export type EmployeeBenefitsResponse<Texpand = unknown> =
  Required<EmployeeBenefitsRecord> & BaseSystemFields<Texpand>;
export type EmployerStatsResponse<Texpand = unknown> =
  Required<EmployerStatsRecord> & BaseSystemFields<Texpand>;
export type EnquiriesResponse<Texpand = unknown> = Required<EnquiriesRecord> &
  BaseSystemFields<Texpand>;
export type FaqTopicsResponse<Texpand = unknown> = Required<FaqTopicsRecord> &
  BaseSystemFields<Texpand>;
export type FaqsResponse<Texpand = unknown> = Required<FaqsRecord> &
  BaseSystemFields<Texpand>;
export type FeaturesResponse<Texpand = unknown> = Required<FeaturesRecord> &
  BaseSystemFields<Texpand>;
export type IntegrationsResponse<Texpand = unknown> =
  Required<IntegrationsRecord> & BaseSystemFields<Texpand>;
export type JobsResponse<Texpand = unknown> = Required<JobsRecord> &
  BaseSystemFields<Texpand>;
export type LeadershipResponse<
  Tsocial_links = unknown,
  Texpand = unknown,
> = Required<LeadershipRecord<Tsocial_links>> & BaseSystemFields<Texpand>;
export type LocationsResponse<
  Tcoordinates = unknown,
  Texpand = unknown,
> = Required<LocationsRecord<Tcoordinates>> & BaseSystemFields<Texpand>;
export type PartnersResponse<Texpand = unknown> = Required<PartnersRecord> &
  BaseSystemFields<Texpand>;
export type PressResponse<Texpand = unknown> = Required<PressRecord> &
  BaseSystemFields<Texpand>;
export type PricingPlansResponse<
  Tfeatures = unknown,
  Tlimitations = unknown,
  Texpand = unknown,
> = Required<PricingPlansRecord<Tfeatures, Tlimitations>> &
  BaseSystemFields<Texpand>;
...
export type StatusResponse<Texpand = unknown> = Required<StatusRecord> &
  BaseSystemFields<Texpand>;
export type SupportResponse<Texpand = unknown> = Required<SupportRecord> &
  BaseSystemFields<Texpand>;
export type TestimonialsResponse<Texpand = unknown> =
  Required<TestimonialsRecord> & BaseSystemFields<Texpand>;
export type UsersResponse<Texpand = unknown> = Required<UsersRecord> &
  AuthSystemFields<Texpand>;
export type ValuesResponse<Texpand = unknown> = Required<ValuesRecord> &
  BaseSystemFields<Texpand>;
export type WebhooksResponse<Theaders = unknown, Texpand = unknown> = Required<
  WebhooksRecord<Theaders>
> &
  BaseSystemFields<Texpand>;
...
export type TypedPocketBase = PocketBase & {
  ...
  collection(
    idOrName: "company_milestones",
  ): RecordService<CompanyMilestonesResponse>;
  collection(
    idOrName: "compliance_items",
  ): RecordService<ComplianceItemsResponse>;
  collection(
    idOrName: "contact_options",
  ): RecordService<ContactOptionsResponse>;
  collection(idOrName: "cta_cards"): RecordService<CtaCardsResponse>;
  collection(
    idOrName: "employee_benefits",
  ): RecordService<EmployeeBenefitsResponse>;
