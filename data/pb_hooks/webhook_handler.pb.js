...
onRecordAfterCreateSuccess(async (e) => {
    ...
    console.log('Full e object (first 300 chars):', JSON.stringify(e).substring(0, 300));
    ...
    try {
        ...
        console.log('Record Collection Name (extracted in hook):', recordCollectionName);
    } catch (err) {
    ...
    try {
        ...
        console.error('*** CRITICAL ERROR in create webhook handler:', error.message);
...
onRecordAfterUpdateSuccess(async (e) => {
    ...
    try {
        ...
        console.error('*** CRITICAL ERROR in update webhook handler:', error.message);
        console.error('*** Stack:', error.stack);
    }
});
...
onRecordAfterDeleteSuccess(async (e) => {
    ...
    try {
        ...
        console.error('*** CRITICAL ERROR in delete webhook handler:', error.message);
        console.error('*** Stack:', error.stack);
    }
});
