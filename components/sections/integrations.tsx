    ...
    >
      <div className="flex size-full max-h-[400px] md:max-h-[500px] lg:max-h-[600px] max-w-2xl md:max-w-4xl lg:max-w-5xl flex-col items-stretch justify-between gap-12 md:gap-16 lg:gap-20">
        <div className="flex flex-row items-center justify-between">
          <Circle ref={div1Ref} className="size-16 md:size-20 lg:size-24">
            <Icons.googleDrive />
          </Circle>
          <Circle ref={div5Ref} className="size-16 md:size-20 lg:size-24">
            <Icons.googleDocs />
          </Circle>
        </div>
        <div className="flex flex-row items-center justify-between">
          <Circle ref={div2Ref} className="size-16 md:size-20 lg:size-24">
            <Icons.notion />
          </Circle>
          <Circle ref={div4Ref} className="size-24 md:size-32 lg:size-40">
            <Icons.openai />
          </Circle>
          <Circle ref={div6Ref} className="size-16 md:size-20 lg:size-24">
            <Icons.zapier />
          </Circle>
        </div>
        <div className="flex flex-row items-center justify-between">
          <Circle ref={div3Ref} className="size-16 md:size-20 lg:size-24">
            <Icons.whatsapp />
          </Circle>
          <Circle ref={div7Ref} className="size-16 md:size-20 lg:size-24">
            <Icons.messenger />
          </Circle>
        </div>
      </div>
