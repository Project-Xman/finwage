...
function LetsTalkButton() {
  return (
    <div className="bg-[#1d44c3] box-border flex gap-2 items-center justify-center px-6 py-3 md:px-8 md:py-4 rounded-full shadow-lg hover:shadow-xl transition-shadow duration-200 w-full md:w-auto min-w-fit" data-name="Link">
...
function Card({ icon, bgColor, title, points }: CardData) {
  return (
    <div className="bg-white rounded-2xl md:rounded-3xl border border-[#d9d8d8] shadow-sm hover:shadow-md transition-shadow duration-200 p-6 md:p-8 h-full" data-name="Background+Border+Shadow">
      <div className="flex flex-col h-full">
            {/* Icon + Title row */}
            <div className="mb-4 md:mb-6">
              <div className="flex items-center gap-4 md:gap-6">
                <div className={`size-12 md:size-14 ${bgColor} rounded-lg flex items-center justify-center flex-shrink-0`}>
                  <Image 
                    alt={`${title} icon`} 
...
function ContentContainer() {
  return (
    <div className="bg-white rounded-2xl md:rounded-3xl border border-[#ecebeb] shadow-xl mx-4 md:mx-8 lg:mx-16 xl:mx-32 my-8 md:my-16" data-name="Frame">
