...
export async function SupportResourcesSection({
  ...
  const getCategoryIcon = (category: string) => {
    ...
    if (lowerCategory.includes('documentation') || lowerCategory.includes('api')) {
          ...
          <div className="max-w-[1280px] mx-auto px-4 md:px-6">
            ...
            <div className="max-w-3xl mx-auto text-center">
              <p className="text-gray-600">
                No support resources available at the moment. Please contact our support team for assistance.
              </p>
            </div>
          </div>
        </section>
        ...
        <div className="max-w-[1280px] mx-auto px-4 md:px-6">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {resources.map((resource) => (
              <Card key={resource.id} className="hover:shadow-xl transition-all group">
                <CardHeader>
