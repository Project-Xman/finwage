...
const Card = ({
  ...
  return (
    <div className="bg-white rounded-2xl p-5 sm:p-6 md:p-5 lg:p-6 shadow-xl hover:shadow-2xl transition-all duration-300 border border-gray-100 w-full md:max-w-[280px] lg:max-w-[320px] backdrop-blur-sm">
      ...
      <h3 className="text-xl sm:text-2xl md:text-xl font-bold text-[#1d44c3] mb-3 md:mb-2 lg:mb-3 text-center">
        {title}
      </h3>
